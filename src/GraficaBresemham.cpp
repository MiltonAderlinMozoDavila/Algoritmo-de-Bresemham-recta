...
#include "../biblioteca/cOperaciones.h"
#include "../biblioteca/cBresemham.h"
...
int main()
{
    ...
    //  --- eliminar los objetos shader una vez que los hayamos vinculado al objeto del programa; ya no los necesitamos más:
    ...
    */
    ...
    // tenga en cuenta que esto está permitido, la llamada a glVertexAttribPointer registró VBO como el objeto de búfer de vértice vinculado del atributo de vértice para que luego podamos desvincularlo de manera segura
